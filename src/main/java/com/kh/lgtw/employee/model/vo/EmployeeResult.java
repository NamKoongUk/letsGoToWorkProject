...
public class EmployeeResult {
	...
	private String topDept;
		...
		public EmployeeResult(int empNo, String empId, String empPwd, String empName, Date empBirth, String gender,
				...
				String leaveType, String jobCode, String jobName, int jobLevel, String deptCode, String deptName,
				String topDept) {
			super();
			this.empNo = empNo;
			this.empId = empId;
		...
		public String toString() {
			return "EmployeeResult [empNo=" + empNo + ", empId=" + empId + ", empPwd=" + empPwd + ", empName=" + empName
					+ ", empBirth=" + empBirth + ", gender=" + gender + ", empPhone=" + empPhone + ", officeTel="
					+ officeTel + ", address=" + address + ", email=" + email + ", managerType=" + managerType
					+ ", status=" + status + ", enrollDate=" + enrollDate + ", retirementDate=" + retirementDate
					+ ", otherInfo=" + otherInfo + ", personalInfoCheck=" + personalInfoCheck + ", refEmpNo=" + refEmpNo
					+ ", lstartDate=" + lstartDate + ", lendDate=" + lendDate + ", leaveTerm=" + leaveTerm
					+ ", leaveReason=" + leaveReason + ", retirementReason=" + retirementReason + ", leaveType="
					+ leaveType + ", jobCode=" + jobCode + ", jobName=" + jobName + ", jobLevel=" + jobLevel
					+ ", deptCode=" + deptCode + ", deptName=" + deptName + ", topDept=" + topDept + "]";
		}
