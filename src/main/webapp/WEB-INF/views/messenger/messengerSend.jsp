		    ...
		    <div class="modal-content" style="width:800px;">
		      ...
		      <div class="modal-body" style="height:500px; width:100%;">
		      	...
		      	<div class="col-sm-4 form-group">
		      		<select class="form-control" name="empList" size="10" style="overflow: auto; width:100%; height:450px;" multiple></select>
		      	</div>
		      	<!-- 수신자 -->
		      		...
		      		<div class="row">
			      		<div>
			      			...
			      			<div class="col-sm-10">
					      		...
					      		<select class="form-control list circleList" name="circleList" size="10" style="width:100%; height:420px;" multiple></select>					      			
			      			</div>		      		
			      		</div>						      	
			      	</div>
		      	</div>
