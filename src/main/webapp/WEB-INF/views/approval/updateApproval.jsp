...
<script type="text/javascript" src="${ contextPath }/resources/ckeditor/ckeditor.js"></script>
	...
	<div class="row wrap">
		...
		<section class="col-sm-10">
			<h3 class="title">${ requestScope.msg }</h3>
			<hr>
			...
			<div id="area" class="content" style="visibility:hidden;">
					  ...
					  <div class="modal-dialog">			
					    ...
					    <div class="modal-content" style="width:800px;">
					      ...
					      <div class="modal-footer">
					        ...
					        <button id="confirm" type="button" onclick="insertInSignForm();" class="btn btn-primary" data-dismiss="modal">확인</button>
					      </div>
					    </div>				
					  </div>
					</div>
					...
					<label>제목 </label>
					<input type="text" id="title" class="form-control" name="adTitle" value="${ requestScope.map.adTitle }">
					<br><br>
					<label>상세내용</label>
				    <div class="form-group">
				        <div class="form-group">
				            <div class="col-lg-12">
				                <textarea name="adContent" id="adContent">${requestScope.map.adContent}</textarea>
				            </div>
				        </div>
				        ...
				        <div class="form-group">
				            <div class="col-lg-12" align="right">
				            	...
				            	<c:if test="${ requestScope.msg != '작성하기'}">
				            		<input type="hidden" name="afNo" value="${ requestScope.map.afNo }">
				            		<input type="hidden" name="adNo" value="${ requestScope.map.adNo }"/>
					                <button onclick="updateApproval();" type="button" class="btn btn-md btn-primary">완료</button>		
...
<script>
	function updateApproval(){
		$("form").attr("action", "${contextPath}/updateApproval.ap");
	...
	$(function(){
		...
		var afNo = '${requestScope.map.afNo}';
		console.log(afNo);
