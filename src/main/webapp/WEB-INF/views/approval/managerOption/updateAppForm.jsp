...
<body>
	...
	<div class="row wrap">
		...
		<section class="col-sm-10">
			<h3 class="title"> 양식수정</h3>
			<hr>
			<div class="content">
				<form class="form-horizontal" role="form" id="editorForm" method="post" action="${ contextPath }/updateAppForm.ap">
					<table class="table table-hover table-bordered">
						<tr>
				        <td class="head">
				        	양식명
				        	<input type="hidden" name ="afNo" value="${ requestScope.form.afNo }">
				        </td>
				        <td>
							<input type="text" name="afName" class="form-control" value="${ requestScope.form.afName }">
						</td>
						<td class="head">약칭</td>
						<td>
							<input type="text" name="afAlias" class="form-control" value="${ requestScope.form.afAlias }">
						</td>
				      </tr>
				       <tr>
				        <td class="head">설명</td>
				        <td>
							<input type="text" name="afComment" class="form-control" value="${ requestScope.form.afComment }">
						</td>
						<td class="head">결재양식</td>
						<td>
							<button class="btn btn-primary" type="button" data-toggle="modal" data-target="#myModal">선택</button>
							<input type="hidden" name="signCode" value="${ requestScope.form.signCode }"/>
							 <!-- Modal -->
					...
					<div id="area">
					    ...
					    <div class="form-group">
					        <div class="form-group">
					            <div class="col-lg-12">
					                <textarea name="afContent" id="ckeditor">
					                	${ requestScope.form.afContent }
					                </textarea>
					            </div>
					        </div>
					        <div class="form-group">
    ...
    $(function(){
    	var afDate = "${ requestScope.form.afDate }";
    	var securityCode = "${ requestScope.form.securityCode }";
    	
    	$("option").each(function(){
    		if($(this).val() == afDate) {
    			$(this).attr("selected", "selected");
    		}
    		if($(this).val() == securityCode) {
    			$(this).attr("selected", "selected");
    		}
    	});
